            ...
            <div>
                ...
                <div class="sitemap-wrap-right-content-main">
                    <table width="100%"  padding="10">
                        ...
                        <tr>
                            <td>대표자</td>
                            <td><input name="representative"></td>
                        </tr>
                        <tr>
                            <td>전화번호</td>
                            <td><input name="phoneNumber" placeholder="'-' 없이 입력해주세요."></td>
                        </tr>
                        <tr>
                            <td>주소(사업장)</td>
                        ...
                        <tr>
                            <td>당초조사기간</td>
                            <td><input type="date" name="Init_surv_period"></td>
                        </tr>
                        <tr>
                            <td>실제조사기간</td>
                            <td><input type="date" name="Act_surv_period"></td>
                        </tr>
                        <tr>
