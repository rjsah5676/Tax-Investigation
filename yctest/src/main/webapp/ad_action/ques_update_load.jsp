...
ret = quesDAO.loadBoard(updateNum);
request.setAttribute("boardNum", ret.get(9));
request.setAttribute("title", ret.get(0));
request.setAttribute("date", ret.get(1));
request.setAttribute("content", ret.get(2));
request.setAttribute("ans", ret.get(3));
RequestDispatcher rd=request.getRequestDispatcher("../admin/ad_admin_ques_update.jsp");
