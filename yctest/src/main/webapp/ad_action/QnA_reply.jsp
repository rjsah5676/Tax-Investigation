...
if (request.getParameter("deleteNum") != null) {
	deleteNum = (String) request.getParameter("deleteNum"); 
}
request.setAttribute("boardNum", deleteNum);
RequestDispatcher rd=request.getRequestDispatcher("../admin/ad_admin_QnA_reply.jsp");
