		...
		<div class="wrap-right">
			<div class="wrap-right-img">
				<img class="sub-title_img"
					src="images/sub_title/ac_signup_title.png">
			</div>
			...
			<div class="signup-wrap-right-content">
				<div class="signup-wrap-right-content-signup_box">
					<div class="signup-wrap-right-content-signup_box-bar">
						...
						<a onclick="movePage('views/ac_signup_submit.jsp')"><img
							src="images/ac_signup/btnSignupTest.png" alt="가입하기"> </a>
					</div>
				</div>
				<br> <br>
					...
					<tbody>
						<tr>
							<td style="padding-left: 10"
								class="signup-wrap-right-content-signup_box-line_dot"><img
								alt="가입용 인증번호 가입안내" src="images/ac_signup/signupImgTest2.png"></td>
						</tr>
						<tr>
							<td style="padding-top: 10px; line-height: 180%">
								<div class="signup-wrap-right-content-signup_box-txt">
									<div class="inner_box">
										<span class="star_red">가입용 인증번호란?</span><br> 당해년도 세무조사
										대상법인에게 제공하는 회원가입용 인증번호 입니다.<br> 관할시에서 발송한 우편물에 세무조사대상법인과
										가입용인증번호가 안내되어 있습니다.
									</div>
									<ul>
										<li>가입용 인증번호는 관할구청에서 법인에게 우편으로 보내드립니다. 가입용 인증번호를 받지 못한
											신고대상 법인은 관할시에 문의 하시기 바랍니다.</li>
										<li>가입용 인증번호는 XXXXXXXXXXX(X는 숫자 11자리) 형식으로 구성되어 있습니다.</li>
										<li>가입용 인증번호로 회원가입시 등록한 아이디/비밀번호로 신고서 작성을 할 수 있으므로
											아이디/비밀번호 관리에 유의 하시기 바랍니다.</li>
									</ul>
								</div>
							</td>
						</tr>
