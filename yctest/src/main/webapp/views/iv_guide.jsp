                        ...
                        <div class="wrap-logo">
                            ...
                            <div class="wrap-right">
                                <div class="iv-wrap-right-img">
                                    <img class="sub-title_img" src="images/sub_title/iv_guide_title.png"></div>
                                                        ...
                                                        <div class="iv-wrap-right-menu">
                                                            <img src="images/investigation/menu-3.gif" alt="서면신고시 참고사항" vspace="3">
                                                                <div class="iv-wrap-right-menu_1">
                                                                    <ul>
                                                                        ...
                                                                        <li >문의사항 전화 :
                                                                            <a onclick="movePage('views/sc_manager.jsp')">
                                                                        ...
                                                                        <li>방문 제출 시 작성해야할
                                                                            <a onclick="movePage('views/iv_archives.jsp')">
                                                            ...
                                                            <div class="iv-wrap-right-menu">
                                                                ...
                                                                <div class="iv-wrap-right-bt">
                                                                    <a href="#info1" onclick="ivInfo('1')"><img alt="지방세납세자권리헌장보기" src="images/investigation/button-1.gif" border="0"/></a>
                                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#info2" onclick="ivInfo('2')"><img alt="세무조사운영규칙보기" src="images/investigation/button-2.gif" border="0"/></a>
