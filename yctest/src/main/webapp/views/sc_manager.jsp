            ...
            <div>
                <div  class="wrap-right__option">
                    <form action="<%= cur_path %>/work.jsp" id="search" method="post">
                    	<input type="hidden" name="search_page" value="../views/sc_manager.jsp">
                ...
                <div>
					...
					<input type="hidden" name= "select_option" value="<%=select_option%>" >
						...
						<a onclick="subForm('action/charge_page_action.jsp','page<%=pageNumber - 1%>')" style="float:left;">이전</a>
					<%
					...
					<input type="hidden" name= "select_option" value="<%=select_option%>" >
						...
						<a onclick="subForm('action/charge_page_action.jsp','page<%=pageNumber + 1%>')" style="float:left;">다음</a>
					<%
						}
					%>
					</div>
