            ...
            <div>
                <div class="wrap-right__option">
                    <form action="<%= cur_path %>/work.jsp" id="search" method="post">
                    	<input type="hidden" name="search_page" value="../views/sc_qna.jsp">
                ...
                <div>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-header">
						...
						<td><a onclick="subForm('action/QnA_action2.jsp','action<%=tmp%>')"><%=list.get(i).getQnA_title() %>
					...
					<input type="hidden" name= "select_option" value="<%=select_option%>" >
						...
						<a onclick="subForm('action/QnA_page_action.jsp','page<%=pageNumber - 1%>')" style="float:left;">이전</a>
					<%
					...
					<input type="hidden" name= "select_option" value="<%=select_option%>" >
						...
						<a onclick="subForm('action/QnA_page_action.jsp','page<%=pageNumber + 1%>')" style="float:left;">다음</a>
					<%
						}
					%>
					</div>
                    <div class="btn_r_org">
                        <input type="button" onclick="movePage('/views/sc_qna_write.jsp')" value="쓰기" class="btn_org">
                    </div>
                    <div id="paging">
