    ...
    <div class="wrap">
        ...
        <div class="wrap-right">
            <div class="wrap-right-img">
               <img class="sub-title_img" alt="서브타이틀" src="images/sub_title/ug_sitemap_title.png">
            </div>
                                        ...
                                        <tr>
                                            <td style="padding-top:1pt">
                                                <ul style="padding-left:0pt; margin-left:1px; list-style:none;">
                                                    ...
                                                    <li><a onclick="movePage('views/no_page.jsp')" class="td_text">신고내역조회</a></li>
                                                    <li><a onclick="movePage('views/no_page.jsp')" class="td_text">신고서출력</a></li>
                                                    <li><a onclick="movePage('views/no_page.jsp')" class="td_text">세무조사결과조회</a></li>
                                                    </c:if>
                                                </ul>
                                            </td>
                                        </tr>
                                ...
                                <tr>
                                    <td style="padding-top:1pt">
                                        <ul style="padding-left:0pt; margin-left:15px; list-style:none;">
                                            ...
                                            <li><a onclick="movePage('views/sc_survey.jsp')" class="td_text">설문</a></li>
                                        </ul>
                                    </td>
                                </tr>
                            </tbody>
                                ...
                                <tr>
                                    <td style="padding-top:1pt">
                                        <ul style="padding-left:0pt; margin-left:15px; list-style:none;">
                                            ...
                                            <c:if test="${isLogin eq null}">
                                            <li><a onclick="movePage('views/no_page.jsp')" class="td_text">정보관리</a></li>
                                            <ul style="padding-left:0pt; margin-left:15px;list-style:none;">
                                                <li><a onclick="movePage('views/no_page.jsp')" class="td_text">기본정보관리</a></li>
                                                <li><a onclick="movePage('views/no_page.jsp')" class="td_text">대리인관리</a></li>
                                                <li><a onclick="movePage('views/no_page.jsp')" class="td_text">회원 탈퇴</a></li>
                                            </ul>
                                            </c:if>
                                ...
                                <tr>
                                    <td style="padding-top:1pt">
                                        <ul style="padding-left:0pt; margin-left:15px; list-style:none; ">
                                            ...
                                            <li><a onclick="pdfPages('1')" class="td_text">PDF파일변환안내</a></li>
                                        </ul>
                                    </td>
                                </tr>
                            </tbody>
