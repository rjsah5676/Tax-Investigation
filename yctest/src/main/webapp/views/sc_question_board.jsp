		...
		<div class="wrap">
			...
			<div class=wrap-left>
				...
				<ul>
					...
					<li><a onclick="movePage('views/sc_question.jsp')"
						class="selected_menu">자주묻는질문</a></li>
			...
			<div class="btn_r_org">
				<input type="button" onclick="movePage('views/sc_question.jsp')"
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tbody>
                		...
                		<input type="hidden" name= "boardNum" value="<%=befStr%>" >
							...
							<a onclick="subForm('action/ques_action2.jsp','action<%=befStr%>')">
							</c:if>
							<%=bef_title %>
							</a></td>
						</tr>
                		...
                		<input type="hidden" name= "boardNum" value="<%=aftStr%>" >
							...
							<a onclick="subForm('action/ques_action2.jsp','action<%=aftStr%>')">
							</c:if><%=aft_title %>
							</a></td>
						</tr>
					</tbody>
