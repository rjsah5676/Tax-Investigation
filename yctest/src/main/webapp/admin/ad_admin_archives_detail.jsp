...
<%@ page import="java.util.ArrayList" %>
	...
	<c:set var="board_now" value="<%=board_now %>"/>
			...
			<form action="<%=cur_path %>/admin/work.jsp" name="delete" method="POST" class="delete">
				...
				<input type="button" onclick="subForm('../ad_action/archives_delete.jsp','delete')"
				...
				<input type="button" onclick="subForm('../ad_action/archives_update_load.jsp','update')"
				value="수정" class="btn_org">
				<input type="button" onclick="movePage('ad_admin_archives.jsp')"
