            ...
            <div>
                <div class="wrap-right__option">
                    <form action="<%= cur_path %>/admin/work.jsp" id="search" method="post">
                        <input type="hidden" name="search_page" value="../admin/ad_admin_notice.jsp">
                ...
                <div>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-header">
						...
						<td><a onclick="subForm('../ad_action/notice_action2.jsp','action<%=tmp%>')"><%=list.get(i).getNotice_title() %></a></td>
					...
					<input type="hidden" name= "select_option" value="<%=select_option%>" >
						...
						<a onclick="subForm('../ad_action/notice_page_action.jsp','page<%=pageNumber - 1%>')" style="float:left;">이전</a>
					<%
					...
					<input type="hidden" name= "select_option" value="<%=select_option%>" >
						...
						<a onclick="subForm('../ad_action/notice_page_action.jsp','page<%=pageNumber + 1%>')" style="float:left;">다음</a>
					<%
						}
					%>
					</div>
                ...
                <div class="btn_r_org">
                        <input type="button" onclick="movePage('ad_admin_notice_write.jsp')" value="쓰기" class="btn_org">
                    </div>
				</div>
                                    </div>
                                </div>
