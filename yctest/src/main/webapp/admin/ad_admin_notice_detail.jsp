...
<%@ page import="java.util.ArrayList" %>
	...
	noticeDAO.viewUpdate(request.getAttribute("ret3").toString(),request.getAttribute("ret_n").toString());
	...
	String file = null;
	if(request.getAttribute("ret4")!=null) file = request.getAttribute("ret4").toString(); 
	...
	<c:set var="board_cnt" value="<%=board_cnt %>"/>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tbody>
						...
						<tr>
							...
							<td width="200px" class="tdw_l"><%=regisdate%></td>
			...
			<form action="<%=cur_path %>/admin/work.jsp" name="delete" method="POST" class="delete">
				...
				<input type="button" onclick="subForm('../ad_action/notice_delete.jsp','delete')"
				...
				<input type="button" onclick="subForm('../ad_action/notice_update_load.jsp','update')"
				value="수정" class="btn_org">
				<input type="button" onclick="movePage('ad_admin_notice.jsp')"
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tbody>
                		...
                		<input type="hidden" name= "boardNum" value="<%=befStr%>" >
							...
							<a onclick="subForm('../ad_action/notice_action2.jsp','action<%=befStr%>')">
							</c:if>
							<%=bef_title %>
							</a></td>
						</tr>
                		...
                		<input type="hidden" name= "boardNum" value="<%=aftStr%>" >
							...
							<a onclick="subForm('../ad_action/notice_action2.jsp','action<%=aftStr%>')">
							</c:if><%=aft_title %>
							</a></td>
						</tr>
					</tbody>
