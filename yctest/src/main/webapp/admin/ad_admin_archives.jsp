			...
			select_option = request.getParameter("select_option");
                   ...
                   <div id="formSet"></div>
                    ...
                    <form action="<%= cur_path %>/admin/work.jsp" id="search" method="post">
                        <input type="hidden" name="search_page" value="../admin/ad_admin_archives.jsp">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="iv-wrap-right-search_table">
						...
						<td><a onclick="subForm('../ad_action/archives_action2.jsp','action<%=tmp%>')"><%=list.get(i).getForm_title() %></a></td>
					...
					<input type="hidden" name= "select_option" value="<%=select_option%>" >
						...
						<a onclick="subForm('../ad_action/archives_page_action.jsp','page<%=pageNumber - 1%>')" style="float:left;">이전</a>
					<%
					...
					<input type="hidden" name= "select_option" value="<%=select_option%>" >
						...
						<a onclick="subForm('../ad_action/archives_page_action.jsp','page<%=pageNumber + 1%>')" style="float:left;">다음</a>
					<%
						}
					%>
					</div>
					<div class="btn_r_org">
                        <input type="button" onclick="movePage('ad_admin_archives_write.jsp')" value="쓰기" class="btn_org">
                    </div>
                </div>
                            </div>
                        </div>
