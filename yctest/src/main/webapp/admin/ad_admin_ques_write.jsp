        ...
        <head>
			...
			<div>
				...
				<form action="<%=cur_path %>/admin/work.jsp" method="post" name="write">
						...
						<tbody>
							<tr>
								...
								<td colspan="3" class="tdw_t_l" style="padding-left: 10pt">
									...
									id="title" name="ques_title" value="" size="70" maxlength="70"
									iskor="Y" urequired="[제목]" uminlen="2">
								</td>
							</tr>
							<tr>
								<td width="130px" height="23px" class="tdo_to_c">등록일자</td>
								<td width="200px" class="tdw_l" colspan="3" style="padding-left: 10pt"><input readonly id="nowdate" name="ques_regisdate">
					...
					<div class="btn_r_org">
						<input type="button" onclick="doWrite('../ad_action/ques_action.jsp')" value="저장"
