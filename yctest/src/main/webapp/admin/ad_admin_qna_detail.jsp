...
<%@ page import="java.util.ArrayList" %>
	...
	<div id="formSet"></div>
                    ...
                    <div class="wrap">
                        <div class="wrap-logo">
                            ...
                            <div class="wrap-left">
                                ...
                                <ul>
									<li><a onclick="movePage('../admin/ad_admin_notice.jsp')">공지사항</a></li>
									<li><a onclick="movePage('../admin/ad_admin_ques.jsp')">자주묻는질문</a></li>
									<li><a href="#" class="selected_menu">Q&A</a></li>
									<li><a onclick="movePage('../admin/ad_admin_charge.jsp')">담당자안내</a></li>
									<li><a onclick="movePage('../admin/ad_admin_survey.jsp')">설문</a></li>
								</ul>
                            </div>
			...
			<form action="<%=cur_path %>/admin/work.jsp" name="delete" method="POST" class="delete">
				...
				<input type="button" onclick="subForm('../ad_action/QnA_delete.jsp','delete')"
				value="삭제" class="btn_org">
				<input type="button" onclick="subForm('../ad_action/QnA_reply.jsp','delete')"
					value="답변달기" class="btn_org">
				<input type="button" onclick="movePage('ad_admin_qna.jsp')"
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tbody>
                		...
                		<input type="hidden" name= "boardNum" value="<%=befStr%>" >
							...
							<a onclick="subForm('../ad_action/QnA_action2.jsp','action<%=befStr%>')">
							</c:if>
							<%=bef_title %>
							</a></td>
						</tr>
                		...
                		<input type="hidden" name= "boardNum" value="<%=aftStr%>" >
							...
							<a onclick="subForm('../ad_action/QnA_action2.jsp','action<%=aftStr%>')">
							</c:if><%=aft_title %>
							</a></td>
						</tr>
					</tbody>
