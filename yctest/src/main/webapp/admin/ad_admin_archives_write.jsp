        ...
        <head>
			...
			<div>
				...
				<form action="<%=cur_path %>/admin/work.jsp" method="post" name="write">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"	
						...
						<tbody>
							<tr>
								...
								<td colspan="3"><input style="width: 300px" name="form_title"/></td>
							</tr>
							<tr>
								<td width="130px" height="23px" class="tdo_to_c">첨부파일</td>
								<td colspan="3"><input style="width: 300px" type="file" name="form_file"/></td>
							</tr>
							<tr>
								<td width="130px" height="23px" class="tdo_to_c">등록일자</td>
								<td width="200px" class="tdw_l" colspan="3" ><input style="width:300px" readonly id="nowdate" name="form_regisdate">
					...
					<div class="btn_r_org">
						<input type="button" onclick="doWrite('../ad_action/archives_action.jsp')" value="저장"
