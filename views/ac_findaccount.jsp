    ...
    <div class="wrap">
        ...
        <div class="wrap-right">
            <div class="wrap-right-img">
                <img src="images/ac_findaccount/findImgTest.png">
            </div>
            ...
            <div class="findaccount-wrap-right-content">
                ...
                <form name="findForm">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tbody>
                            <tr>
                                <td style="padding-left:15px"><img alt="아이디찾기" src="images/ac_findaccount/findIdTest.png""></td>
                                <td width="50%" style="padding-left:20px"><img alt="비밀번호찾기" src="images/ac_findaccount/findPasswordTest.png"></td>
                            </tr>
                        </tbody>
                    </table>
                    <div class="findaccount-wrap-right-content-box">
                        <div class="findaccount-wrap-right-content-box-id_pw_find">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tbody><tr> 
                                    <td width="49%" valign="top"> 
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tbody><tr> 
                                            <td class="findaccount-wrap-right-content-box-id_pw_find-id_box">
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                <tbody><tr> 
                                                <td height="100px" valign="top" style="padding-left:5px" align="left">                           
                                                    <ul>
                                    ...
                                    <td width="16" valign="middle"><img alt="" src="images/ac_findaccount/barTest.png"></td>
                                    ...
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        ...
                                        <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
                                            <tbody><tr> 
                                                ...
                                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                    <tbody><tr> 
                                                    <td height="100" valign="top" style="padding-left:5" align="left">                 
                                                    <ul>
                                                        <li>아이디와 법인등록번호,사업자등록번호,가입용인증번호를  입력하시면 임시비밀번호를 보여드립니다.</li>
                                                        <li>변경된 비밀번호로 로그인 한 후 기본정보관리에서 
                                                                비밀번호를 변경하실 수 있습니다.</li>
                                                    </ul>														                                                                                                                                     
                                                    </td>
                                                    </tr>
                                                </tbody></table>
